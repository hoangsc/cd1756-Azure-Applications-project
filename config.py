...
class Config(object):
    ...
    BLOB_ACCOUNT = os.environ.get('BLOB_ACCOUNT') or 'hcfirststorage01'
    BLOB_STORAGE_KEY = os.environ.get('BLOB_STORAGE_KEY') or '+NIaRxw0V0su5r4lqCNRDbh/hvR0WvzLNrdElBvMYKXjUsAE9P0Jdqrgsy52r7F7KwjOSnFq+md++ASt5VNbJw=='
    ...
    CLIENT_SECRET = "_ZC8Q~qusXAmI_62YH6HHT_sPjg1kFHihQiWWbqN"
